# [什么是语法糖？Java中有哪些语法糖？](https://mp.weixin.qq.com/s/o4XdEMq1DL-nBS-f8Za5Aw)
...
从反编译后代码可以看出，可变参数在被使用的时候**，他首先会==创建一个数组==，数组的长度就是调用该方法是传递的实参的个数，然后再把参数值全部放到这个数组当中，然后再把这个数组作为参数传递到被调用的方法中**。
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/iaIdQfEric9TwNmDhZm21t9wOBDpHgMyic3Uca1D6QMY20rv4kDFRZicftLPOy3n7PDNd4NMwhyvAsLWTO5UfibPZnA/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
